...
- **Required/Optional:** No required books enforced (min_books=1) to maximize coverage given mixed availability; optional books lists mirror weights above. Dual-sharp requirement can be enabled later once coverage is denser.
...
- `reports/outlier_preset_core.json` (Props Core)  
  ...
  - Weights source: priors_blended_with_props_ml; generated_at: 2025-12-31T10:45:51Z

- `reports/outlier_preset_expansion.json` (Gamelines Expansion)  
  - Optional books: Pinnacle, Circa, BookMaker.eu, BetOnline.ag  
  - Devig: Probit; EV min: 1.00%; Kelly: 1/2; min_books: 1  
  - Weights source: odds_api_only (outcome-calibrated); generated_at: 2025-12-31T10:45:51Z
